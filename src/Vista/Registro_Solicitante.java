...
public class Registro_Solicitante extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Registro_Solicitante
     */
    ...
    private void initComponents() {
        ...
        btnCREAR.setBackground(new java.awt.Color(0, 0, 102));
        btnCREAR.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        btnCREAR.setForeground(new java.awt.Color(255, 255, 255));
        btnCREAR.setText("REGISTRARME");
        btnCREAR.setBorderPainted(false);
        jPanel2.add(btnCREAR, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 300, 150, 40));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Registro_Solicitante.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Registro_Solicitante().setVisible(true);
            }
        });
    }
