...
public class V_Solicitante extends javax.swing.JFrame {
    ...
    /**
     * Creates new form V_Solicitante
     */
    ...
    java.util.logging.Logger.getLogger(V_Solicitante.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
}
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new V_Solicitante().setVisible(true);
            }
        });
    }
